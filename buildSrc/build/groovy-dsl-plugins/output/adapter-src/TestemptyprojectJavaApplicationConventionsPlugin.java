...
/**
 * Precompiled testemptyproject.java-application-conventions script plugin.
 **/
public class TestemptyprojectJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_TestemptyprojectJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("testemptyproject.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_TestemptyprojectJavaApplicationConventions").asSubclass(BasicScript.class);
